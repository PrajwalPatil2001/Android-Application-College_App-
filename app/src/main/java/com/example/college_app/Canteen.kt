 ...
 * Use the [Canteen.newInstance] factory method to
 * create an instance of this fragment.
 */
class Canteen : Fragment() {
    ...
    private lateinit var canteendetails: TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        canteendetails = view.findViewById(R.id.canteendetails)

        news.setOnClickListener {
            if (canteendetails.visibility == View.GONE) {
                canteendetails.visibility = View.VISIBLE
            } else {
                canteendetails.visibility = View.GONE
            }
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment Canteen.
         */
